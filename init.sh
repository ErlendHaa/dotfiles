...
if [ ! -d "$HOME/vimconf" ]; then
    git clone https://github.com/timss/vimconf.git "$HOME/vimconf"
    ln -sf "$HOME/vimconf/.vimrc" "$HOME/.vimrc"
fi
...
echo ""
echo "Run 'cfg <command>' as you would for git."
echo ""
echo "You can now safely delete $CURDIR if you wish, as all files have been copied to your home directory."
echo "  rm -rf $CURDIR"
